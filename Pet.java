...
public class Pet extends Player {
    ...
    private static final String[] chatPr = {"T vả chet me m", "Bảo kê cho sư phụ", "Dám đụng vào sư phụ t này", "T cho m chết"};
   ...
   private void increasePoint() {
        if (this.nPoint != null && Util.canDoWithTime(lastTimeIncreasePoint, 1)) {
            if (Util.isTrue(30, 100)) {
                if (this.nPoint != null && this.nPoint.dameg + 1000 < this.nPoint.getDameLimit()) {
                this.nPoint.increasePoint((byte) 2, (short) Util.nextInt(50));
                } else {
                this.nPoint.increasePoint((byte) 2, (short) 1);
                }
            } else {
                byte type = (byte) Util.nextInt(0, 1);
                if (this.nPoint != null && this.nPoint.hpg + 1000 < this.nPoint.getHpMpLimit() && this.nPoint.mpg + 1000 < this.nPoint.getHpMpLimit()) {
                this.nPoint.increasePoint(type, (short)50);
                } else {
                this.nPoint.increasePoint(type,(short) 1);
                }
            }
...
//                case 4:
//                    if (this.nPoint.power >= 60000000000000000L) {
//                        openSkill5();
//                    }
//                    break;
            }
