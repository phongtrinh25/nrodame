...
//                session.isvip = rs.getBoolean("isvip");
                session.goldBar = rs.getInt("account.thoi_vang");
                session.bdPlayer = rs.getDouble("account.bd_player");
                session.vnd = rs.getInt("account.tongnap");
                session.coinBar = rs.getInt("account.coin");
                session.napt2 = rs.getInt("nap_t2");
                session.napt3 = rs.getInt("nap_t3");
                session.napt4 = rs.getInt("nap_t4");
                session.napt5 = rs.getInt("nap_t5");
                session.napt6 = rs.getInt("nap_t6");
                session.napt7 = rs.getInt("nap_t7");
                session.napCN = rs.getInt("nap_CN");
                session.napTuan = rs.getInt("tongtien_1_tuan");
...
//                    Service.gI().sendThongBaoOK(session, "Tài khoản đang được đăng nhập tại máy chủ khác");
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            player.isquavip = rs.getByte("quavip");
                            player.haveTennisSpaceShip = rs.getBoolean("have_tennis_space_ship");
                            player.isqua = rs.getInt("nhanqua");
                            ...
                            player.pointevent = rs.getInt("event");
                            player.isqua1 = rs.getInt("nhanqua1");
                            player.isqua2 = rs.getInt("nhanqua2");
                            player.isqua3 = rs.getInt("nhanqua3");
                            player.isqua4 = rs.getInt("nhanqua4");
                            player.isqua5 = rs.getInt("nhanqua5");
                            ...
                            if (dataArray.size() >= 4) {
                                player.inventory.coupon = Integer.parseInt(String.valueOf(dataArray.get(3))); // file này thừa
                            } else {
                            ...
                            //data nạp
                            dataArray = (JSONArray) jv.parse(rs.getString("data_nap"));
                            player.isnapt2 = Byte.parseByte(String.valueOf(dataArray.get(0)));
                            player.isnapt3 = Byte.parseByte(String.valueOf(dataArray.get(1)));
                            player.isnapt4 = Byte.parseByte(String.valueOf(dataArray.get(2)));
                            player.isnapt5 = Byte.parseByte(String.valueOf(dataArray.get(3)));
                            player.isnapt6 = Byte.parseByte(String.valueOf(dataArray.get(4)));
                            player.isnapt7 = Byte.parseByte(String.valueOf(dataArray.get(5)));
                            player.isnapCN = Byte.parseByte(String.valueOf(dataArray.get(6)));
                            player.isnapTUAN = Byte.parseByte(String.valueOf(dataArray.get(7)));
                            dataArray.clear();
                            ...
                            try {
                                ...
                                if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapBlackBallWar(mapId)
                                        || MapService.gI().isMapConDuongRanDoc(mapId) || MapService.gI().isMapBanDoKhoBau(mapId)
                                        || MapService.gI().isMapKhiGas(mapId) || MapService.gI().isMapMaBu(mapId) || MapService.gI().isnguhs(mapId)) {
                            ...
                            if (player.nPoint.power < 0) {
                                player.nPoint.power = 80000000000L;
                            }
                            if (player.nPoint.tiemNang < 0) {
                            ...
                            for (int i = player.inventory.itemsBody.size(); i < 16; i++) {
                                player.inventory.itemsBody.add(ItemService.gI().createItemNull());
                            }
                            dataArray.clear();
                            ...
                            dataArray = (JSONArray) jv.parse(rs.getString("data_bingo"));
                            int time20hp = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            int time20ki = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            int time20sd = Integer.parseInt(String.valueOf(dataArray.get(2)));
//                            player.itemTime.lasttimewish1Bingo = time20hp;
//                            player.itemTime.lastTimewish2biNgo = time20ki;
//                            player.itemTime.lasttimeWish3Bingo = time20sd;
                            player.itemTime.lasttimewish1Bingo = System.currentTimeMillis()
                                    - (ItemTime.TIME_MAY_DO - time20hp);
                            player.itemTime.lastTimewish2biNgo = System.currentTimeMillis()
                                    - (ItemTime.TIME_MAY_DO - time20ki);
                            player.itemTime.lasttimeWish3Bingo = System.currentTimeMillis()
                                    - (ItemTime.TIME_MAY_DO - time20sd);

                            player.itemTime.isWish1Bingo = time20hp != 0;
                            player.itemTime.isWish2Bingo = time20ki != 0;
                            player.itemTime.isWish3Bingo = time20sd != 0;
                            dataArray.clear();
                            ...
                            //data bánh
                            dataArray = (JSONArray) jv.parse(rs.getString("data_dh"));
                            player.dh1 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.dh2 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.dh3 = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            dataArray.clear();
                            dataArray = (JSONArray) jv.parse(rs.getString("data_dh1"));
                            player.dh4 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.dh5 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.dh6 = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            dataArray.clear();
                            //data bánh
                            dataArray = (JSONArray) jv.parse(rs.getString("isdh"));
                            player.isdh1 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.isdh2 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.isdh3 = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            dataArray.clear();
                            dataArray = (JSONArray) jv.parse(rs.getString("isdh1"));
                            player.isdh4 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.isdh5 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.isdh6 = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            dataArray.clear();
                            //data super
                            dataArray = (JSONArray) jv.parse(rs.getString("data_item_super"));
                            int super1 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            int super2 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            int super3 = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            player.itemTime.lastTimesp1 = System.currentTimeMillis() - (ItemTime.TIME_SUPER - super1);
                            player.itemTime.lastTimesp2 = System.currentTimeMillis() - (ItemTime.TIME_SUPER - super2);
                            player.itemTime.lastTimesp3 = System.currentTimeMillis() - (ItemTime.TIME_SUPER - super3);

                            player.itemTime.isUsesp1 = super1 != 0;
                            player.itemTime.isUsesp2 = super2 != 0;
                            player.itemTime.isUsesp3 = super3 != 0;
                            //data sk
                            dataArray = (JSONArray) jv.parse(rs.getString("data_sk"));
                            int sk = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.itemTime.lastTimesk = System.currentTimeMillis() - (ItemTime.TIME_SK - sk);
                            player.itemTime.isUsesk = sk != 0;
                            dataArray.clear();
                            ...
                            //data trứng lnh thu
                            dataArray = (JSONArray) jv.parse(rs.getString("trunglinhthu"));
                            if (dataArray.size() != 0) {
                                player.trunglinhthu = new BillEgg(player, Long.parseLong(String.valueOf(dataArray.get(0))),
                                        Long.parseLong(String.valueOf(dataArray.get(1))));
                            }
                            dataArray.clear();
                            ...
                            if (!petData.isEmpty()) {
                                ...
                                if (pet.nPoint.power < 0) {
                                    pet.nPoint.power = 40000000000L;
                                }
                                if (pet.nPoint.tiemNang < 0) {
                                    pet.nPoint.tiemNang = 40000000000L;
                                }
                                //data body
                            ...
                            dataArray = (JSONArray) JSONValue.parse(rs.getString("info_day"));
                            if (!dataArray.isEmpty()) {
                                player.nhanqua = Byte.parseByte(String.valueOf(dataArray.get(1)));
                                player.lastTimeNhanQua = Long.parseLong(String.valueOf(dataArray.get(0)));
                            ...
                            if ((new java.sql.Date(player.lastTimeNhanQua)).getDay() != (new java.sql.Date(System.currentTimeMillis())).getDay()) {
                                player.nhanqua = 0;
                            }
    ...
    public static Player loadById(int id) {
        ...
        try {
            ...
            if (rs.first()) {
                long plHp = 200000000L;
                long plMp = 200000000L;
                JSONValue jv = new JSONValue();
                JSONArray dataArray = null;
                ...
                try {
                    ...
                    player.location.x = Integer.parseInt(String.valueOf(dataArray.get(1)));
                    player.location.y = Integer.parseInt(String.valueOf(dataArray.get(2)));
                    if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapConDuongRanDoc(mapId)
                            || MapService.gI().isMapKhiGas(mapId) || MapService.gI().isMapBlackBallWar(mapId)
    ...
    public static Player loadByIdSieuHang(int id) {
        ...
        try {
            ...
            if (rs.first()) {
                ...
                //data pet
                player.nPoint.hp = (long) plHp;
                player.nPoint.mp = (long) plMp;
                player.iDMark.setLoadedAllDataPlayer(true);
            }
        } catch (Exception e) {
            e.printStackTrace();
