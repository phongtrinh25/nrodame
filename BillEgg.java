...
public class BillEgg {
    ...
    // public static final long DEFAULT_TIME_DONE = 86_400_000L;
    public static final long DEFAULT_TIME_DONE = 60_000L;
    ...
    public void openEggLinhThu() {

        destroyEgg(true);
        try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            Logger.logException(Util.class, e, "safeSleep");
        }
        ChangeMapService.gI().changeMapInYard(this.player, this.player.zone.map.mapId, -1, Util.nextInt(300, 500));

    }

    public void destroyEgg(boolean isLinhThu) {
        try {
