...
//            case 54:
    ...
    private static final String[] textQuyLao = new String[]{
        "fide Là 1 Tựa Game Rất Hay",
        "Chào Mừng Anh Em tới Vs ngọc rồng fide",
        "Tựa Game Hot Nhất 2024",
        "Lối Chơi Đa Dạng"
    };
...
//public void createEventMenu(Player player) {
//    Message msg;
//    try {
//        String [] menuSelect = new String[]{"Chúc mừng\nnăm mới", "Đóng"};
//        player.iDMark.setIndexMenu(ConstNpc.EVENT_MENU);
//        msg = new Message(32);
//        msg.writer().writeShort(tempId);
//        msg.writer().writeUTF("năm mới an lành");
//        msg.writer().writeByte(menuSelect.length);
//        for (String menu : menuSelect) {
//            msg.writer().writeUTF(menu);
//        }
...
//        if (!NpcManager.isPlayerInNpcListUser(player,tempId)) {
//                        this.createEventMenu(player);                        
//                    }
        ...
        if (player.zone.map.mapId == this.mapId
            ...
            if (player.isfight || player.isfight1 || player.istry || player.istry1){
                this.npcChat(player, "Lo đánh đi ấn ấn con cẹc");
            } else {
