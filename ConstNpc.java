...
public class ConstNpc {
    ...
    public static final byte Hatchiyack = 75;
    public static final byte GOHAN_NHAT_NGUYET = 76;
    public static final byte THAN_TAI = 77;
    public static final byte Nang_Tien_Ca = 78;
    public static final byte bi_ngo = 79;
    public static final byte Broly = 80;
    public static final byte Noel = 81;
    public static final byte WHIS1 = 82;
    public static final byte WHIS2 = 83;
    public static final byte BR = 84;
    public static final byte NOEL = 86;
    public static final byte Valentin = 87;
    public static final byte Valentin1 = 88;
    public static final byte TX = 89;
    public static final byte SK = 90;
    public static final byte Moc = 91;
    public static final byte SGK = 93;
    //----------------------index menu------------------------------------------
    ...
    public static final int CHE_TAO_SACH = 528;
    ...
    public static final int SUMMON_HALLOWEEN_SHENRON = 529;
    ...
    public static final int HALLOWWEN = 507;
    public static final int ICE_SHENRON = 5070;
    ...
    public static final int VU_LAN = 50886;
    public static final int HS_LICHTEN = 50885;
    public static final int RAP_HOA_DANG = 50884;
    public static final int DANH_HIEU = 50883;
    public static final int SUMMON_ICE_SHENRON = 5190;
    ...
    public static int SHOW_INFOR_NAP = 561;
    public static final int EVENT_MENU = 7520020;
}
