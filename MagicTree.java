...
public class MagicTree {
    ...
    public static final short[] PEA_TEMP = {13, 60, 61, 62, 63, 64, 65, 352, 523, 595, 1261};
    public static final int[] PEA_PARAM = {100, 500, 2, 4, 8, 16, 32, 64, 128, 256, 1500};
...
// {200, 4, 0, 3000} nâng cấp mất 300 ngày và , 4 giờ, 0 phút, và hết 3000 tức là 3 tỷ vàng
    ...
    public void loadMagicTree() {
        ...
        try {
            ...
            String name = level > 10 ? "Đậu Thần Cấp 11" : "Đậu thần cấp " + level;// đậu levo 11 có tên khác
